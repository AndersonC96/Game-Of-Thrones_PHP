<?php
    ...
    class Book {
        ...
        public static function getAllBooks() {
            ...
            $url = 'https://www.anapioficeandfire.com/api/books'; // Substitua pela URL real da API
        ...
        public static function getBookById($id) {
            ...
            $url = 'https://www.anapioficeandfire.com/api/books/' . $id; // Substitua pela URL real da API
            // Faz a requisição GET para a API
            $json = file_get_contents($url);
            // Decodifica o JSON retornado e o transforma em um array associativo
            return json_decode($json, true);
